...
const int N = 3; // Number of particles in the world
const int d = 3; // d dimension world
double mass[N] = {1, 1, 1}; // mass of each particles
const int Nu = 1; // Nucleus number
double nucl_pos[Nu][3] = {{0, 0, 0}}; // Nucleus position
